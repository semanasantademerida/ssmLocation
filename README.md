...
La aplicación ha sido refactorizada y optimizada en la versión **2.29** siguiendo un diseño modular para facilitar su mantenimiento. Cada fichero incluye documentación detallada en español.
